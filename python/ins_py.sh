...
if [ -f "/etc/lsb-release" ]; then
  ...
  yum install -y gcc gcc-c++ make zlib-devel openssl-devel sqlite-devel \
                 readline-devel libffi-devel bzip2-devel wget perl \
                 xz-devel libuuid-devel tk-devel gdbm-devel expat-devel
fi
